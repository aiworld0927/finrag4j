-- ============================================
-- FinRag4j Nacos 数据库初始化脚本 - 步骤2
-- 严格按照官方 pg-schema.sql 执行
-- Nacos 版本: 3.2.2
-- ============================================
...
-- ----------------------------
-- Indexes and Primary Keys for config_info
-- ----------------------------
CREATE UNIQUE INDEX "uk_configinfo_datagrouptenant" ON "config_info" ("data_id","group_id","tenant_id");
ALTER TABLE "config_info" ADD CONSTRAINT "config_info_pkey" PRIMARY KEY ("id");

-- ----------------------------
-- Indexes and Primary Keys for config_tags_relation
-- ----------------------------
...
-- ----------------------------
-- Indexes and Primary Keys for group_capacity
-- ----------------------------
...
-- ----------------------------
-- Indexes and Primary Keys for his_config_info
-- ----------------------------
...
-- ----------------------------
-- Indexes and Primary Keys for tenant_info
-- ----------------------------
...
CREATE UNIQUE INDEX "uk_ai_resource_ns_name_type" ON "ai_resource" USING btree ("namespace_id", "name", "type", "c_from");
...
CREATE UNIQUE INDEX "uk_ai_resource_version_ns_name_ver" ON "ai_resource_version" USING btree ("namespace_id", "name", "type", "version");
